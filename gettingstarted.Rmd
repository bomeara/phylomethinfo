...
4. Copy the text below the instructions into a new file gettingstarted_exercise.Rmd (you can make this in Rstudio)
5. Edit the file and render it when done. Make sure to add the new html file and the Rmd file back to GitHub, and contact me on slack to let me know it's done.

### Code to paste into your Rmd file

````
`r paste(readLines('gettingstarted_example.txt'), collapse = '\n')`
````
